        ...
        <SectionThree>
          <FlexBoxIndex>
            ...
            <div className="text__section3">
              ...
              <GenereicPara lessSize lessSpacing>
                We hand code beautiful websites using HTML5, CSS3, JS because
                they are fully customizable and efficient. No Worpress websites
                here.
              </GenereicPara>
            </div>
          </FlexBoxIndex>
          ...
          <FlexBoxIndex>
            ...
            <div className="text__section3">
              ...
              <GenereicPara lessSize lessSpacing>
                We develop Mobile apps in Reactive Native, which can be used in
          ...
          <div className="grid__section4">
            ...
            <div className="item3" style={{ backgroundColor: "#484A83" }}>
              ...
              <GenereicPara lessSize lessSpacing grey>
                ...
                development, mobile development and app development and
                everything else.
              </GenereicPara>
            </div>
